...
export default function DbClient() {
  ...
  return (
      <main className="w-full px-2 md:px-6 md:h-[calc(100vh-4rem)] flex flex-col">

        <section className={`grid grid-cols-1 md:grid-cols-4 gap-6 flex-1 overflow-hidden min-h-0`}>
            <div className="md:col-span-1 pt-6 w-full md:h-full md:overflow-hidden">
                <SearchCard onSelect={setSelectedItem} />
            </div>
            <div className="md:col-span-3 pt-6 w-full md:h-full md:overflow-hidden">
